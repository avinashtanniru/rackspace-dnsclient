...
// checks if the ZoneSelfLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneSelfLink{}

// ZoneSelfLink struct for ZoneSelfLink
type ZoneSelfLink struct {
...
func (o ZoneSelfLink) MarshalJSON() ([]byte, error) {
...
func (o ZoneSelfLink) ToMap() (map[string]interface{}, error) {
...
type NullableZoneSelfLink struct {
	value *ZoneSelfLink
	isSet bool
}

func (v NullableZoneSelfLink) Get() *ZoneSelfLink {
	return v.value
}

func (v *NullableZoneSelfLink) Set(val *ZoneSelfLink) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneSelfLink) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneSelfLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneSelfLink(val *ZoneSelfLink) *NullableZoneSelfLink {
	return &NullableZoneSelfLink{value: val, isSet: true}
}

func (v NullableZoneSelfLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneSelfLink) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
func (r ApiInfoGetRequest) Execute() (*AppInfo, *http.Response, error) {
	return r.ApiService.InfoGetExecute(r)
}

/*
InfoGet Get metadata info
...
//  @return AppInfo
func (a *DefaultAPIService) InfoGetExecute(r ApiInfoGetRequest) (*AppInfo, *http.Response, error) {
	var (
